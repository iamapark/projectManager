...
public class Project extends Activity implements OnClickListener {
	...
	private static final int MSG_PROGRESS = 1;		// pBar��吏꾪뻾��泥섎━�섍린 �꾪븳 硫붿떆吏�肄붾뱶
	...
	private void cal() throws ParseException{
		...
		if(cd > 0)
			...
			ddayView.setText("D"+cd);
			Calendar oCalendar = Calendar.getInstance( );  // �꾩옱 �좎쭨/�쒓컙 �깆쓽 媛곸쥌 �뺣낫 �산린
			...
			//maxProgress = 30;
			// pBar��理쒕�媛�-->maxProgress ((�꾩옱�좎쭨-�쒖옉�좎쭨)/(�붾뜲���쒖옉�좎쭨)*100) �섏쨷���좎쭨諛쏆븘��꽌�섏젙�댁빞��

			// ProgressBar��吏꾪뻾��泥섎━���ㅻ젅���앹꽦 諛��쒖옉
			pThread = new ProgressThread();
			pThread.start();	
	}

	
	private class ProgressThread extends Thread			// ProgressThread: �꾨줈洹몃젅�ㅻ컮��吏꾪뻾��泥섎━�섎뒗 �ㅻ젅��
	{
	...
	private class ProgressHandler extends Handler		// ProgressHandler: �꾨줈洹몃젅�ㅻ컮���낅뜲�댄듃瑜��대떦�섎뒗 �몃뱾��
	{
