...
public class Register extends Activity implements OnClickListener {
	...
	private void findName(String xmlString) {
		...
		try {
			...
			Log.e("占쏙옙占쏙옙", ""+e.getMessage());
		}
		Log.e("占쏙옙占쏙옙", "占쏙옙占싸그뤄옙 占쏙옙占쏙옙");
	...
	Handler handler = new Handler(){
		public void handleMessage(Message msg){
			if(msg.what==1){
				//Toast.makeText(Register.this, "�숈씪���꾩씠�붽� �대� 議댁옱�⑸땲��", Toast.LENGTH_LONG).show();
			}else{
				//Toast.makeText(Register.this, "怨꾩젙 �앹꽦���꾨즺�섏뿀�듬땲��", Toast.LENGTH_LONG).show();
